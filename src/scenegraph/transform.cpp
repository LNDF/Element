...
scenegraph::transform::transform() : owner(nullptr), position(0.0f), scale(1.0f), rotation(glm::vec3(0.0f, 0.0f, 0.0f)) {}

scenegraph::transform::transform(const node_ref& owner) : owner(owner), position(0.0f), scale(1.0f), rotation(glm::vec3(0.0f, 0.0f, 0.0f)) {}
